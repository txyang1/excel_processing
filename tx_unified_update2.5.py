...
# === 3. 打开原表，清除旧的粉/蓝高亮 & 清空尾行 ===
wb = load_workbook(orig_fp)
ws = wb[sheet]

# 要清除的颜色
if clear_flag == "Y":
    purple_codes = {"FFFFC0CB", "FFC0CB","00FFC0CB"}  # 新增用粉色
...
purple_fill = PatternFill("solid", fgColor="FFC0CB")
...
# === 6. 保存 ===
wb.save(upd_fp)
print(f"更新完成 (来源={source_key})，粉色=新增，蓝色=更新。结果保存在 '{upd_fp}'。")